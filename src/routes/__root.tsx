...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Räume mit Charakter: Innenraumgestaltung mit handwerklicher Präzision und gestalterischem Anspruch vom Meisterbetrieb in Fellbach." },
