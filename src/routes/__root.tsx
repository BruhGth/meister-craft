...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Wir verändern Räume: Innenraumgestaltung mit handwerklicher Präzision und gestalterischem Anspruch vom Meisterbetrieb in Fellbach." },
      { name: "author", content: "Raumgeschneidert" },
